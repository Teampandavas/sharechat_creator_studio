...
# INSERTING Data into MojDB

Default_Data = [ 
    (56, "shareadmin", "tester@gmail.com", "367238", 
    "{'overall': {'New Viewers': '11K', 'Views': '3.2K', 'followers': '13k','New Viewer SC' : '2K','Views SC' :'1K','followers SC' : '13K', 'New Views pct': '30', 'Views Pct': '72', 'follow pct': '45'}, 'Analytics':{'TP': '1234', 'TWH': '20.2', 'WL': [888, 270, 998, 501, 423, 608, 400, 3, 8, 0]}}"),
    ...
    (35, "Easeter", "easter@gmail.com", "989137827", 
    "{'overall':'28K', 'Views': '3.6M', 'followers': '14K'}, 'New Views pct': '60', 'Views Pct': '92', 'follow pct': '80'},'Analytics':{'TP': '2022', 'TWH': '9.8', 'WL': [8, 2, 9, 5, 4, 6, 4, 3, 8, 0]}}"),

    (165, "Broker", "broker@gmail.com", "112337827", 
    "{'overall':{'New Viewers': {'New Viewers': '12K', 'Views': '9.8M', 'followers': '58909'}, 'New Views pct': '60', 'Views Pct': '92', 'follow pct': '89'},'Analytics':{'TP': '6800', 'TWH': '6.7', 'WL': [8, 2, 9, 5, 4, 6, 4, 3, 8, 0]}}"),
]

for row in Default_Data:
    MojDB_db = MojDB(id=row[0], name=row[1], email=row[2], phone=row[3], post=row[4])
    MojDB_db.save()